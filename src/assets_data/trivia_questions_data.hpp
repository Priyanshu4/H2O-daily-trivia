...
namespace pico_trivia {
	...
	std::array<TriviaQuestion, 25> trivia_questions = {
		...
		TriviaQuestion("Which carnivorous plant can digest not only insects, but also lizards and rodents?", "Pitcher Plant", {"Venus Flyrap", "Cobra Lily", "Portuguese Sundew"}, &bamboo_theme),
