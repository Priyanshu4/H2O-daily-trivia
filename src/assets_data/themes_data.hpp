...
namespace pico_trivia
{
	...
	pico_trivia::Theme generic_theme(&pico_trivia::question_marks_background, {255, 255, 255});
	...
	pico_trivia::Theme animals_theme(&pico_trivia::animals_background, {255, 255, 255});
